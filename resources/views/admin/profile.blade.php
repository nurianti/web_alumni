            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-8 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Silahkan Lengkapi Identitas Diri</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" action="/alumni" enctype="multipart/form-data"  class="form-horizontal form-material">
                                {{ csrf_field() }}
                                <div class="form-group mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="hidden" placeholder=""
                                                class="form-control p-0 border-0" name="id_user" value="{{ auth()->user()->id_user }}"
                                                id="example-email" disable readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">NIM</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder=""
                                                class="form-control p-0 border-0" name="nim" value="{{ auth()->user()->username }}"
                                                id="example-email" disable readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="nama" class="form-control p-0 border-0" value="{{ auth()->user()->name }}" disable readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
