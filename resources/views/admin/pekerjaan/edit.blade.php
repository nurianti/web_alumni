            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" action="/admin/pekerjaan/{{ $pekerjaan->id }}" enctype="multipart/form-data" class="form-horizontal form-material">
                                @method('put') 
                                @csrf
                                    <div class="form-group mb-4"> 
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            ...
                                            @foreach ($alumni as $alumni)
                                                @if(old('alumni_id', $pekerjaan->alumni_id) == $alumni->id)
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="nama_instansi" id="nama_instansi" value="{{ old('nama_instansi', $pekerjaan->nama_instansi) }}"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="bulan_bekerja" id="bulan_bekerja" value="{{ old('bulan_bekerja', $pekerjaan->bulan_bekerja) }}"
                                                class="form-control p-0 border-0"> </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="tahun_bekerja" id="tahun_bekerja" value="{{ old('tahun_bekerja', $pekerjaan->tahun_bekerja) }}"
                                                class="form-control p-0 border-0"> </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="nama_perusahaan_sebelumnya" id="nama_perusahaan_sebelumnya" value="{{ old('nama_perusahaan_sebelumnya', $pekerjaan->nama_perusahaan_sebelumnya) }}"
                                                class="form-control p-0 border-0"> </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="mulai_kerja" id="mulai_kerja" value="{{ old('mulai_kerja', $pekerjaan->mulai_kerja) }}"
                                                class="form-control p-0 border-0"> </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="alasan_keluar" id="alasan_keluar" value="{{ old('alasan_keluar', $pekerjaan->alasan_keluar) }}"
                                                class="form-control p-0 border-0"> </div>
